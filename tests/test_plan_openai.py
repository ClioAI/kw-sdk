"""
Test plan mode with OpenAI provider.
...
def main():
    # Configure harness - OpenAI in plan mode
    ...
    print(f"Running plan mode test with OpenAI")
    ...
    output_file = "outputs/test_plan_openai_output.md"
    os.makedirs("outputs", exist_ok=True)
    
    with open(output_file, "w") as f:
        f.write(f"# Plan Mode Test - OpenAI\n\n")
        f.write(f"## Task\n{TASK}\n\n")
        f.write(f"## Plan\n{PLAN}\n\n")
        f.write(f"## Rubric\n{RUBRIC}\n\n")
        f.write("---\n\n")
