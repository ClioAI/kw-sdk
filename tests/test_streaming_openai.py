...
# Configure harness - OpenAI with streaming enabled
...
print(f"Running task with OpenAI (streaming): {task[:50]}...")
print("-" * 50)
...
with open("tests/test_streaming_openai_output.md", "w") as f:
    if error:
        f.write(f"# Error\n\n{error}\n\n---\n\n")
...
print("Results saved to tests/test_streaming_openai_output.md")
if error:
