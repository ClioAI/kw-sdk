...
print(f"Running task with OpenAI: {task[:50]}...")
print("-" * 50)
...
with open("test_sdk_openai_output.md", "w") as f:
    if error:
        f.write(f"# Error\n\n{error}\n\n---\n\n")
...
print("Results saved to test_sdk_openai_output.md")
if error:
    print("RUN FAILED - see test_sdk_openai_output.md for details")
else:
    print(f"\nAnswer preview:\n{result.answer[:500]}...")
