...
# Configure harness - OpenAI with search disabled (creative task)
...
print(f"Running EXPLORE mode: {task[:80]}...")
print("-" * 50)
...
with open("test_explore_output.md", "w") as f:
    f.write("# Explore Mode Test\n\n")
...
print("Results saved to test_explore_output.md")
if error:
    print("RUN FAILED - see test_explore_output.md for details")
else:
    print(f"\nExploration preview:\n{result.answer[:1000]}...")
