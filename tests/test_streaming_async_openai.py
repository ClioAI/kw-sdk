...
from verif.providers import openai as openai_provider

# Force the requested model for this test.
openai_provider.MODEL_ID = "gpt-5.2"
...
async def main():
    ...
    print(f"Running async streaming task with OpenAI: {TASK}")
    print("-" * 60)
    ...
    output_path = "tests/outputs/test_streaming_async_openai_output.md"
    with open(output_path, "w") as f:
        f.write("# Streaming Test Results (OpenAI Async)\n\n")
