...
STANDARD_MODE = ModeConfig(
    ...
    tools=["create_brief", "create_rubric", "delegate", "build_skill", "verify_answer", "submit_answer"],
...
PLAN_MODE = ModeConfig(
    ...
    tools=["create_rubric", "delegate", "build_skill", "verify_answer", "submit_answer"],
    verification_tool="verify_answer",
...
EXPLORE_MODE = ModeConfig(
    ...
    tools=["create_brief", "delegate", "build_skill", "verify_exploration", "submit_answer"],  # No create_rubric
...
ITERATE_MODE = ModeConfig(
    ...
    tools=["delegate", "verify_answer", "submit_answer"],  # No brief/rubric creation
    verification_tool="verify_answer",
